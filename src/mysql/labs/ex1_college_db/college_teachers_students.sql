...
CREATE TABLE `teachers_students` (
  ...
  `teacher_student_student_id` int NOT NULL,
  `teacher_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `student_id_idx` (`teacher_student_student_id`),
  KEY `teacher_id_idx` (`teacher_id`),
  CONSTRAINT `teacher_id` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `teacher_student_student_id` FOREIGN KEY (`teacher_student_student_id`) REFERENCES `students` (`id`)
...
INSERT INTO `teachers_students` VALUES (1,1,1),(2,1,2),(3,2,2),(4,3,1),(5,3,2),(6,4,1);
